...
export default function StoryPromptsCarousel() {
  ...
  if (isLoading) {
    return (
      <section
        id="story-prompts"
        className="py-12 sm:py-16 bg-black border-t-4 border-[#f9c937]"
      >
        <div className="px-4 sm:px-8 mb-6 sm:mb-8">
          ...
          <div className="mt-3 sm:mt-4 w-32 sm:w-48 h-2 bg-[#f9c937]" />
        </div>
        <div className="px-8">
    ...
    >
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
              <h2 className="font-syne text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#f9c937] uppercase tracking-tighter">
                HISTORIAS
              </h2>
              <h2 className="font-syne text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white uppercase tracking-tighter">
                DE LA COMUNIDAD
              </h2>
            </div>
            <div className="flex-1 h-2 sm:h-4 bg-[#f9c937] mt-2 mb-2" />
            <p className="mt-2 font-archivo-black text-xs sm:text-sm text-white/60 uppercase tracking-widest">
      ...
      <div className="px-4 sm:px-8 mt-6 sm:mt-8">
        <Link
          href="/stories"
          className="
            inline-block px-6 sm:px-8 py-3 sm:py-4 bg-[#f9c937] border-4 border-black
            font-archivo-black text-black text-sm sm:text-lg uppercase tracking-wider
      ...
      <div className="mt-8 sm:mt-12 flex items-center justify-center gap-4 px-4 sm:px-8">
