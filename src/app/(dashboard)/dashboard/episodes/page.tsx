  ...
  return (
    <div className="bg-white p-8">
      ...
      <div className="flex items-center justify-between mb-6 p-4 bg-black/[0.03] border-4 border-black">
        ...
        <PageIndicator currentPage={pagination.page} totalPages={pagination.totalPages} />
        <PaginationNav
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-black text-white">
              <th className="px-4 py-4 font-archivo-black text-xs uppercase text-left">#</th>
              <th className="px-4 py-4 font-archivo-black text-xs uppercase text-left">Título</th>
              <th className="px-4 py-4 font-archivo-black text-xs uppercase text-left">Plataforma</th>
              <th className="px-4 py-4 font-archivo-black text-xs uppercase text-left">Fecha</th>
              <th className="px-4 py-4 font-archivo-black text-xs uppercase text-left">Duración</th>
              <th className="px-4 py-4 font-archivo-black text-xs uppercase text-left">Invitados</th>
              <th className="px-4 py-4 font-archivo-black text-xs uppercase text-left">Acciones</th>
            </tr>
          </thead>
          <tbody>
              ...
              >
                ...
                <td className="px-4 py-4">
                  <div className="flex gap-2">
                    <button
                      onClick={() => router.push(`/dashboard/episodes/${episode.id}`)}
