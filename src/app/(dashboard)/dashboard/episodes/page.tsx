  ...
  return (
    <div className="bg-white p-4 sm:p-8">
      ...
      <div className="overflow-x-auto -mx-4 sm:mx-0">
        <div className="bg-white border-3 sm:border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] sm:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] overflow-hidden min-w-[600px]">
          <table className="w-full">
            <thead>
              <tr className="bg-black text-white">
                <th className="px-3 sm:px-4 py-3 sm:py-4 font-archivo-black text-[10px] sm:text-xs uppercase text-left">
                  #
                </th>
                <th className="px-3 sm:px-4 py-3 sm:py-4 font-archivo-black text-[10px] sm:text-xs uppercase text-left">
                  Título
                </th>
                <th className="px-3 sm:px-4 py-3 sm:py-4 font-archivo-black text-[10px] sm:text-xs uppercase text-left hidden sm:table-cell">
                  Plataforma
                </th>
                <th className="px-3 sm:px-4 py-3 sm:py-4 font-archivo-black text-[10px] sm:text-xs uppercase text-left">
                  Fecha
                </th>
                <th className="px-3 sm:px-4 py-3 sm:py-4 font-archivo-black text-[10px] sm:text-xs uppercase text-left hidden md:table-cell">
                  Duración
                </th>
                <th className="px-3 sm:px-4 py-3 sm:py-4 font-archivo-black text-[10px] sm:text-xs uppercase text-left hidden lg:table-cell">
                  Invitados
                </th>
                <th className="px-3 sm:px-4 py-3 sm:py-4 font-archivo-black text-[10px] sm:text-xs uppercase text-left">
                  Acciones
                ...
                return (
                  ...
                  >
                    <td className="px-3 sm:px-4 py-3 sm:py-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-black text-[#f9c937] font-archivo-black flex items-center justify-center text-xs sm:text-sm">
                    ...
                    <td className="px-3 sm:px-4 py-3 sm:py-4">
                      <div className="flex items-center gap-2 sm:gap-3">
                        {displayImage && (
                          <div className="relative w-12 h-10 sm:w-16 sm:h-12 bg-[#f9c937] border-2 border-black flex-shrink-0 overflow-hidden">
                            <Image
                              src={displayImage}
                              alt={episode.title}
                              fill
                        ...
                        <div className="min-w-0">
                          <p className="font-syne font-bold text-black text-xs sm:text-sm uppercase leading-tight truncate max-w-[120px] sm:max-w-none">
                            {episode.title}
                          </p>
                          {episode.isExclusive && (
                            <span className="inline-block mt-1 px-1.5 py-0.5 bg-[#f9c937] text-black font-archivo-black text-[9px] sm:text-xs uppercase border border-black">
                              ★ Exclusivo
                            </span>
                          )}
                          ...
                          <span
                            className={`
                            inline-block mt-1 px-1.5 py-0.5 font-archivo-black text-[9px] sm:text-xs uppercase border-2 border-black sm:hidden
                    ...
                    <td className="px-3 sm:px-4 py-3 sm:py-4 hidden sm:table-cell">
                      <span
                        className={`
                        inline-block px-2 sm:px-3 py-1 font-archivo-black text-xs uppercase border-2 border-black
                        ${episode.platformType === "YOUTUBE" ? "bg-red-600 text-white" : ""}
                        ${episode.platformType === "SPOTIFY" ? "bg-green-500 text-white" : ""}
                        ${episode.platformType === "PATREON" ? "bg-gray-500 text-white" : ""}
                        ${episode.platformType === "OTHER" ? "bg-gray-500 text-white" : ""}
                    ...
                    <td className="px-3 sm:px-4 py-3 sm:py-4 font-plus-jakarta text-xs sm:text-sm text-black/70">
                      {formatDate(episode.publishedAt)}
                    </td>
                    <td className="px-3 sm:px-4 py-3 sm:py-4 font-archivo-black text-xs sm:text-sm text-black/70 hidden md:table-cell">
                      ...
                      {episode.guests && episode.guests.length > 0 ? (
                        <div className="flex flex-wrap gap-1">
                          {episode.guests.slice(0, 2).map((guest) => (
                            <span
                              key={guest.id}
                              className="px-1.5 py-1 bg-black text-[#f9c937] font-archivo-black text-xs border border-[#f9c937]/30"
                              title={guest.name}
                            >
                          ...
                          {episode.guests.length > 2 && (
                            <span className="px-1.5 py-1 bg-black/20 text-black/70 font-archivo-black text-xs">
                              +{episode.guests.length - 2}
                            </span>
                          )}
                        </div>
                    ...
                    <td className="px-3 sm:px-4 py-3 sm:py-4">
                      <div className="flex gap-1 sm:gap-2">
                        <button
                          ...
                          className="px-2 sm:px-3 py-1.5 sm:py-2 bg-black text-white font-archivo-black text-[10px] sm:text-xs uppercase border-2 border-black hover:bg-[#f9c937] hover:text-black transition-colors"
                        >
                          Ver
                        </button>
                        <button
                          ...
                          className="px-2 sm:px-3 py-1.5 sm:py-2 bg-[#f9c937] text-black font-archivo-black text-[10px] sm:text-xs uppercase border-2 border-black hover:bg-black hover:text-[#f9c937] transition-colors"
                        >
                          Edit
                        </button>
                        <button
                          ...
                          className="px-2 sm:px-3 py-1.5 sm:py-2 bg-white text-red-600 font-archivo-black text-[10px] sm:text-xs uppercase border-2 border-black hover:bg-red-600 hover:text-white transition-colors disabled:opacity-50"
                        >
